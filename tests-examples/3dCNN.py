...
main_path = r'E:\New folder (3)\WASL/'
...
# Build 1D CNN model for keypoint data
log_dir = os.path.join('Logs')
tb_callback = TensorBoard(log_dir=log_dir)

model = Sequential([
    Input(shape=(sequence_length, 1662)),  # Input shape: 30 frames x 1662 keypoints
...
with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
    while cap.isOpened():
        ...
        # Save to video (resize frame to match output dimensions)
